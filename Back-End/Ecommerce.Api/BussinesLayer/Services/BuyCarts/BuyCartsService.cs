...
namespace BussinesLayer.Services.BuyCarts
{
    public class BuyCartsService : Repository<BuyCart, BuyCartViewModel, MainDbContext>, IBuyCartsService
    {

        private MainDbContext _context;
        private readonly IMapper _mapper;

        public BuyCartsService(MainDbContext context, IMapper mapper) : base(context, mapper)
        {
            _context = context;
            _mapper = mapper;
        }
