...
{
    public class UserAddressService : Repository<UserAddress, UserAddressViewModel, MainDbContext>, IUserAddressService
    {
        private MainDbContext _context;
        private readonly IMapper _mapper;


        public UserAddressService(MainDbContext context, IMapper mapper) : base(context, mapper)
        {
            _context = context;
            _mapper = mapper;
        }
